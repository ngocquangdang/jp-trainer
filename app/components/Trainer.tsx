    ...
    return (
      <>
        ...
        <div className="w-full flex items-center justify-between text-sm text-gray-500 mt-2">
          <span>Lượt đã hiển thị: {shownCounts[currentIndex] ?? 1} / 2</span>
          <span>
          ...
          <div className="w-full">
            ...
            >
              {[
                ...
                const isActive =
                  viewMode === (tab.key as "hiragana" | "katakana");
                const base =
                  "w-full rounded-lg border px-3 py-2 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-offset-2";
                const active =
                ...
                return (
                  <button
                    ...
                    className={className}
                    onClick={() =>
                      handleSelectViewMode(tab.key as "hiragana" | "katakana")
                    }
                    onKeyDown={(e) => {
                      if (e.key === "Enter" || e.key === " ")
                        handleSelectViewMode(
                          tab.key as "hiragana" | "katakana"
                        );
                    }}
                  >
                    {tab.label}
